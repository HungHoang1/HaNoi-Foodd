  ...
  return access_token ? (
    ...
    <AnimationWrapper keyValue={type}>
      <section
        ...
        style={{ backgroundImage: "url(https://www.wowweekend.vn/document_root/upload/articles/image/BrowseContent/Enjoy/202006/Movenpick/Coffee%20Cuisine%202.jpg)" }}
      >
        <Toaster />
        <form id="formElement" className="w-[80%] max-w-[400px]">
          <h1 className="text-4xl text-white font-gelasio capitalize text-center mb-24">
          ...
          {type == "sign-in" ? (
            <p className="mt-6 text-white text-xl text-center">
              Không có tài khoản ?
              <Link to="/sign-up" className="underline text-white text-xl ml-1">
                Đăng ký
              </Link>
            </p>
          ) : (
            <p className="mt-6 text-white text-xl text-center">
              ...
              <Link to="/sign-in" className="underline text-white text-xl ml-1">
                Đăng nhập tại đây.
              </Link>
            </p>
          )}
